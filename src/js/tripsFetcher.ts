...
import {AGENTS, DIRECTIONS} from "./constants";
import {getDirection} from "./utils";

const ALFA_BUS_ARROW_TRIP_SPLITTER = ' -> ';

const getAlfaBusTrips = (direction: DIRECTIONS, date: string) => {
...
const getAtlasBusTrips = (direction: DIRECTIONS, date: string) => {
                            ...
                            return axios({
                                ...
                                .then((response: any) => {
                                    ...
                                    return rides
                                        ...
                                        .filter((trip: any) => trip.freeSeats > 0);
                                });
                        } else {
                            return rides
                                .map((trip: any) => {
...
const getAllTrips = (direction: DIRECTIONS, date: string) => {
    return Promise.all([
